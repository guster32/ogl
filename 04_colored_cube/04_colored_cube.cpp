...
int main( void )
{
	...
	GLuint programID = LoadShaders( "TransformVertexShader.vs.glsl", "ColorFragmentShader.fs.glsl" );
	...
	glm::mat4 Model2      = translation * rotation * scale;//glm::mat4(1.0f); // Model matrix : an identity matrix (model will be at the origin)
	...
	static const GLfloat g_trianle_color_buffer_data[] = { 
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(g_trianle_color_buffer_data), g_trianle_color_buffer_data, GL_STATIC_DRAW);
